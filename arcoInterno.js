var ArcoInterno = SupBarrido.extend({
	initialize: function(puntosRecorrido, basesRecorrido)
	{
		...
		curva = new CurvaBezier([ [-0.5,0.25,0], [-0.3,0.5,0], [0.3,0.5,0], [0.5,0.25,0], [0.5,0.13,0], [0.5,-0.04,0], [0.5,-0.25,0], [0.17,-0.25,0], [-0.16,-0.25,0], [-0.5,-0.25,0], [-0.5,-0.04,0], [-0.5,0.13,0], [-0.5,0.25,0] ]);
