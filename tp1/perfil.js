/****************************************
Perfil
Esta clase abstracta representa a un perfil plano compuesto por una determinada cantidad de vertices

Por convención se asume que el perfil generador se encuentra en el plano xy (se utiliza como ortogonal el eje z)!!!
Los rotados pueden no cumplir esto claramente
****************************************/

var Perfil = Base.extend({
	initialize: function()
	{
		this.puntos;
		this.normales;
